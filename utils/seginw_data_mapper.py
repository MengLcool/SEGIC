...
def build_transform_gen(cfg, is_train, empty=True):
    """
    ...
    cfg_input = {'RANDOM_FLIP':"horizontal"} 
    image_size = 1024
    min_scale = 0.8
    max_scale = 1.5
    ...
    # if cfg_input['RANDOM_FLIP'] != "none" and not empty:
    #     augmentation.append(
    #         T.RandomFlip(
    ...
    # augmentation.extend([
    #     T.ResizeShortestEdge([800, 1024], 1024, ),
    #     # T.ResizeScale(
